...
#import initialize_1D as initialize_1D
...
if __name__ == '__main__':
    ...
    #c = initialize_1D.solve_f(case.grid['ycs'], (2*np.pi/nx_g), yloc, U1, Ur, delta)
    ...
    u[idx1] = u1
    u[idx2] = u2
    #u = initialize_1D.u_profile(y, yloc, U1, Ur, delta, c)
    v    = phi1*V1 + (1. - phi1)*V2
    #print(u.shape)

    np.save("u_computed.npy", u)
    #print("Velocity field saved to u_computed.npy")
