...
class TKE_Budget:
    ...
    def surface_tension(self):
        ...
        #Debug
        #print("phi min =", np.nanmin(phi))
        #print("phi max =", np.nanmax(phi))
        #print("1 - phi max =", 1 - np.nanmax(phi))
        #if(1 - np.nanmax(phi) < 0): print(1)
        #print("num phi < 0   =", np.count_nonzero(phi < 0.0))
        #print("num phi > 1   =", np.count_nonzero(phi > 1.0))
        #print("num phi NaN   =", np.count_nonzero(np.isnan(phi)))
